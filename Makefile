...
$(MAIN): $(MAIN).cpp cascinf.cpp Snap.o lapack.o blas.o dnchbv.o dgexpv.o dgmatv.o dgpadm.o
	g++  -o $(MAIN) $(MAIN).cpp cascinf.cpp dgraph.cpp dgraph_snca.cpp dgraph_slt.cpp dgraph_sdom.cpp dgraph_lt.cpp dgraph_iter.cpp Snap.o blas.o lapack.o dnchbv.o dgexpv.o dgmatv.o dgpadm.o -lgfortran  -I./glib -I./snap $(LDFLAGS)

dominator_trees: dominator_trees.cpp cascinf.cpp Snap.o lapack.o blas.o dnchbv.o dgexpv.o dgmatv.o dgpadm.o
	g++ -o dominator_trees dominator_trees.cpp cascinf.cpp dgraph.cpp dgraph_snca.cpp dgraph_slt.cpp dgraph_sdom.cpp dgraph_lt.cpp dgraph_iter.cpp Snap.o blas.o lapack.o dnchbv.o dgexpv.o dgmatv.o dgpadm.o -lgfortran  -I./glib -I./snap $(LDFLAGS) 

find_sets: find_sets.cpp cascinf.cpp Snap.o lapack.o blas.o dnchbv.o dgexpv.o dgmatv.o dgpadm.o
	g++ -o find_sets find_sets.cpp cascinf.cpp dgraph.cpp dgraph_snca.cpp dgraph_slt.cpp dgraph_sdom.cpp dgraph_lt.cpp dgraph_iter.cpp Snap.o blas.o lapack.o dnchbv.o dgexpv.o dgmatv.o dgpadm.o -lgfortran  -I./glib -I./snap $(LDFLAGS) 

generate_nets: generate_nets.cpp cascinf.cpp Snap.o lapack.o blas.o dnchbv.o dgexpv.o dgmatv.o dgpadm.o
	g++ -o generate_nets generate_nets.cpp cascinf.cpp dgraph.cpp dgraph_snca.cpp dgraph_slt.cpp dgraph_sdom.cpp dgraph_lt.cpp dgraph_iter.cpp Snap.o blas.o lapack.o dnchbv.o dgexpv.o dgmatv.o dgpadm.o -lgfortran  -I./glib -I./snap $(LDFLAGS) 
